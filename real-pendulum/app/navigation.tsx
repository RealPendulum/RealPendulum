...
export default function NavigationBar({
  ...
  return (
    <nav className="grid grid-cols-5 items-center bg-white p-3">
      <div
        className="col-span-2 flex justify-center items-center font-mono text-5xl m-5 text-amber-700"
        style={{ textShadow: "0 2px 3px #000" }}
      >
        RealPendulum
      </div>

      <div className="col-span-3 flex flex-row items-center p-3">
        {[
          ["Home", Urls.homeURL],
          ["Game", Urls.gameURL],
